        ...
        >
          <div className="relative mb-8">
            ...
            <p className="text-lg leading-relaxed text-muted mt-4">
              ...
              <AnimatedArcHighlight color="var(--highlight-indigo)" delay={2.5}>large language models</AnimatedArcHighlight> to create intuitive and efficient user interfaces.
            </p>
          </div>
        </motion.div>
